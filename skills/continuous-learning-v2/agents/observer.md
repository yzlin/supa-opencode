---
name: observer
description: Background agent that analyzes session observations to detect patterns and create instincts. Uses gpt-5.3-codex-spark for cost-efficiency. v2.1 adds project-scoped instincts.
...
- Project: `~/.config/opencode/homunculus/projects/<project-hash>/observations.jsonl`
- Global fallback: `~/.config/opencode/homunculus/observations.jsonl`
...
- Project: `~/.config/opencode/homunculus/projects/<project-hash>/instincts/personal/`
- Global: `~/.config/opencode/homunculus/instincts/personal/` (for universal patterns)
